...
const LOGIN_REWARDS = [
  ...
  { day: 3,  coins: 100,  xp: 200,  bonus: 'power_lightning',  label: 'Day 3 — Bonus Power!' },
...
const DAILY_ORCHARD_TASKS = [
  ...
  { id: 'task_no_overflow', desc: 'Complete a chapter with no overflow danger', target: 1, reward: { coins: 200, xp: 300 } },
];
