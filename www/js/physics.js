...
export class PhysicsWorld {
  ...
  constructor(playWidthScale = 1) {
    if (typeof Matter === 'undefined') {
      // This should never happen in normal play — main.js waits for
      // Matter.js to load before constructing any Game/PhysicsWorld.
      // If you hit this, something is calling PhysicsWorld too early.
      throw new Error('PhysicsWorld: Matter.js is not loaded yet. Make sure main.js awaits waitForMatter() before creating a Game.');
    }
    const { Engine } = Matter;
