...
const RANKS = [
  { name: 'Legend',   minScore: 20000, color: '#FF6B35' },
  { name: 'Master',   minScore: 10000, color: '#9B59B6' },
  { name: 'Diamond',  minScore:  5000, color: '#00BCD4' },
  { name: 'Platinum', minScore:  2500, color: '#78909C' },
  { name: 'Gold',     minScore:  1000, color: '#FFC107' },
  { name: 'Silver',   minScore:   500, color: '#90A4AE' },
