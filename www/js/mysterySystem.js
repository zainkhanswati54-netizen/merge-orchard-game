...
export const SECRET_FRUITS = [
  { id: 'rainbow_fruit', name: 'Rainbow Fruit', emoji: '🌈', desc: 'A legendary fruit that can merge with anything!', rarity: 'legendary', chance: 0.005 },
  { id: 'golden_apple',  name: 'Golden Apple',  emoji: '🍏', desc: 'Worth 10x points when merged!',                rarity: 'rare',      chance: 0.015 },
  { id: 'phantom_fruit', name: 'Phantom Fruit', emoji: '👻', desc: 'Passes through walls! Mysterious...',          rarity: 'rare',      chance: 0.012 },
  { id: 'bomb_fruit',    name: 'Bomb Fruit',    emoji: '💣', desc: 'Merges ALL adjacent same-tier fruits at once!',rarity: 'epic',     chance: 0.008 },
  { id: 'star_fruit',    name: 'Star Fruit',    emoji: '⭐', desc: 'Grants bonus XP and coins when merged!',       rarity: 'uncommon',  chance: 0.02  },
];
...
export const MYSTERY_BOX_REWARDS = [
  ...
  { type: 'power',      label: '❄️ Freeze Power',    value: 'freeze', weight: 10 },
