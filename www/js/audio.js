...
async function loadBuffer(ctx, key, url) {
  try {
    ...
    console.warn(`[audio] skipping ${key}: ${e.message}`);
  }
}
...
export function preloadAudio() {
  // Sound files replaced by Web Audio synthesis (juiceEngine.js + musicEngine.js)
  // Resolve immediately so loading screen never freezes
...
export function startMusic() {
  // Music now handled by musicEngine.js (procedural Web Audio)
