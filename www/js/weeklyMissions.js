...
const WEEKLY_TEMPLATES = [
  { id: 'weekly_merges_500',  type: 'merge',       target: 500,  desc: 'Merge {n} fruits this week',       reward: { coins: 1000, xp: 2000 } },
  { id: 'weekly_merges_1000', type: 'merge',       target: 1000, desc: 'Merge {n} fruits this week',       reward: { coins: 2000, xp: 4000 } },
  { id: 'weekly_score_10000', type: 'score',       target: 10000,desc: 'Score {n} total points this week', reward: { coins: 1500, xp: 3000 } },
  { id: 'weekly_score_25000', type: 'score',       target: 25000,desc: 'Score {n} total points this week', reward: { coins: 3000, xp: 6000 } },
  { id: 'weekly_combos_50',   type: 'combo',       target: 50,   desc: 'Achieve {n} combos this week',     reward: { coins: 800,  xp: 1600 } },
  { id: 'weekly_combos_100',  type: 'combo',       target: 100,  desc: 'Achieve {n} combos this week',     reward: { coins: 1800, xp: 3600 } },
  { id: 'weekly_games_20',    type: 'games',       target: 20,   desc: 'Play {n} matches this week',       reward: { coins: 600,  xp: 1200 } },
  { id: 'weekly_danger_30',   type: 'dangerMerge', target: 30,   desc: 'Make {n} danger-zone merges',      reward: { coins: 1200, xp: 2400 } },
  { id: 'weekly_legendary',   type: 'legendary',   target: 3,    desc: 'Achieve {n} Legendary Combos',     reward: { coins: 2500, xp: 5000 } },
  { id: 'weekly_drops_300',   type: 'drop',        target: 300,  desc: 'Drop {n} fruits this week',        reward: { coins: 700,  xp: 1400 } },
];
